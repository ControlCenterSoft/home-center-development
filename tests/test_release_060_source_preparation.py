...
def test_release_060_release_notes_remain_historical_and_truthful() -> None:
...
def test_release_060_upgrade_drills_remain_bound_to_exact_historical_public_stable() -> None:
    for name in (
