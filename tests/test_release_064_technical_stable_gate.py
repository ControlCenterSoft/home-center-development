...
def test_release_064_target_node_decision_remains_content_addressed() -> None:
...
def test_release_064_single_node_profile_keeps_provider_ha_and_commercial_claims_unclaimed() -> None:
...
def test_release_064_target_and_complete_artifacts_remain_hard_gates() -> None:
    decision = evaluate_single_node_technical_stable(
        version=VERSION,
        revision=REVISION,
        qualification=_qualification(),
...
def test_release_064_target_evidence_cannot_cross_candidate_artifacts() -> None:
    decision = evaluate_single_node_technical_stable(
        version=VERSION,
        revision=REVISION,
        qualification=_qualification(),
...
def test_release_064_invalid_identity_is_rejected() -> None:
