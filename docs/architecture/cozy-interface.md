...
Последний опубликованный релиз Home Center — `0.22.3`. Патчи 0.22.1–0.22.3 исправляют Web-интерфейс и rolling-update/deployment-profile migration, не расширяя исполнительную границу линии 0.22. Текущий кандидат `0.23.0` завершает durable home-service transition scope; Household/Intent foundation не расширяет этот кандидат.
