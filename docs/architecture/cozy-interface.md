...
Опубликованный baseline Home Center — `0.22.0`. Текущий кандидат `0.23.0` завершает durable home-service transition scope; Household/Intent foundation не расширяет этот кандидат.
