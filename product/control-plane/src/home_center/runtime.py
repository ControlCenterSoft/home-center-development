...
from .device_management_enrollment_verification_recovery import RecoverableDeviceManagementEnrollmentVerificationRuntimeService
...
class Runtime:
    def __init__(
        ...
        *,
        ...
        self.device_management_enrollment_verification = RecoverableDeviceManagementEnrollmentVerificationRuntimeService(self.store)
