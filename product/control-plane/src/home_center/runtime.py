...
from .device_management_enrollment_execution_runtime_safe import SafeDeviceManagementEnrollmentExecutionRuntimeService
...
class Runtime:
    def __init__(
        ...
        *,
        ...
        self.device_management_enrollment_execution = SafeDeviceManagementEnrollmentExecutionRuntimeService(self.store)
