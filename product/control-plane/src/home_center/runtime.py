...
from .device_management_enrollment_execution_runtime import DeviceManagementEnrollmentExecutionRuntimeService
...
class Runtime:
    def __init__(
        ...
        *,
        ...
        self.device_management_enrollment_execution = DeviceManagementEnrollmentExecutionRuntimeService(self.store)
